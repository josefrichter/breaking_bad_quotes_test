...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_32869 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_32869(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_32877 = (function (runtime,key,spec){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_32877(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_32882 = (function (runtime,key){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_32882(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_32888 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_32888(thing,opts);
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_32898 = (function (runtime,input,callback){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_32898(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_32908 = (function (runtime,code){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_32908(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__32855,callback){
...
var input = map__32856__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32856__$1,new cljs.core.Keyword(null,"code","code",1586293142));
