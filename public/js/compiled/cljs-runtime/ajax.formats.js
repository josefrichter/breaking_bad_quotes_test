...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__27335){
...
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27336__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var format = ajax.formats.get_default_format(response,request);
var fexpr__27342 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__27342.cljs$core$IFn$_invoke$arity$1 ? fexpr__27342.cljs$core$IFn$_invoke$arity$1(response) : fexpr__27342.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__27343){
...
var request = map__27344__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27344__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
