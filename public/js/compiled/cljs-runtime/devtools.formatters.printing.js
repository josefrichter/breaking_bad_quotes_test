...
var len__4736__auto___27731 = arguments.length;
var i__4737__auto___27732 = (0);
while(true){
if((i__4737__auto___27732 < len__4736__auto___27731)){
args__4742__auto__.push((arguments[i__4737__auto___27732]));

var G__27733 = (i__4737__auto___27732 + (1));
i__4737__auto___27732 = G__27733;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq27702){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27703,G__27704,seq27702__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27712_SHARP_){
return (!((cljs.core.meta(p1__27712_SHARP_) == null)));
})))){
...
var map__27713 = opts;
var map__27713__$1 = (((((!((map__27713 == null))))?(((((map__27713.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27713.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27713):map__27713);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27713__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e27717){var _e__26249__auto__ = e27717;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e27719){var _e__26249__auto__ = e27719;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__27722 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__27723 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__27723);

try{var map__27724 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27724__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__27722);
}});
...
var temp__5733__auto___27762 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___27762)){
var managed_print_level_27763 = temp__5733__auto___27762;
var _STAR_print_level_STAR__orig_val__27728_27764 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__27729_27765 = managed_print_level_27763;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__27729_27765);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__27726_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__27726_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__27728_27764);
}} else {
job_fn();
}
