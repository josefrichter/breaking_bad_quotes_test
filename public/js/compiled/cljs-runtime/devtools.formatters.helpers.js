...
var G__27693 = devtools.prefs.pref(v);
v = G__27693;
continue;
} else {
return v;
...
}catch (e27655){var _e__26249__auto__ = e27655;
return false;
}})();
...
}catch (e27663){var _e__26249__auto__ = e27663;
return false;
}})();
...
}catch (e27668){var _e__26249__auto__ = e27668;
return false;
}}
}
});
...
var vec__27681 = devtools.munging.parse_constructor_info(constructor_fn);
...
return cljs.core.some((function (p1__27684_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27684_SHARP_);
}),template);
});
