...
var len__4736__auto___28939 = arguments.length;
var i__4737__auto___28940 = (0);
while(true){
if((i__4737__auto___28940 < len__4736__auto___28939)){
args__4742__auto__.push((arguments[i__4737__auto___28940]));

var G__28941 = (i__4737__auto___28940 + (1));
i__4737__auto___28940 = G__28941;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__28833_28942 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__28834_28943 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__28835_28944 = true;
var _STAR_print_fn_STAR__temp_val__28836_28945 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__28835_28944);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__28836_28945);

try{var _STAR_print_level_STAR__orig_val__28837_28948 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28838_28949 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28838_28949);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28837_28948);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__28834_28943);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__28833_28942);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq28831){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq28831));
}));
...
var new_formatters = current_formatters.filter((function (p1__28878_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__28878_SHARP_)));
}));
...
var G__28885_28977 = f;
var target__26243__auto___28978 = G__28885_28977;
if(cljs.core.truth_(target__26243__auto___28978)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28885_28977)].join(''),"\n","target__26243__auto__"].join('')));
}

(target__26243__auto___28978["toString"] = (function (){
...
var G__28890_28983 = "%c%s";
var G__28891_28984 = "color:transparent";
var G__28892_28985 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__28890_28983,G__28891_28984,G__28892_28985) : f.call(null,G__28890_28983,G__28891_28984,G__28892_28985));
...
var args__4742__auto__ = [];
var len__4736__auto___28986 = arguments.length;
var i__4737__auto___28987 = (0);
while(true){
if((i__4737__auto___28987 < len__4736__auto___28986)){
...
var vec__28907 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28907,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28907,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__28989__delegate = function (add_fmt,add_args){
...
var G__28989 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__28991__i = 0, G__28991__a = new Array(arguments.length -  1);
while (G__28991__i < G__28991__a.length) {G__28991__a[G__28991__i] = arguments[G__28991__i + 1]; ++G__28991__i;}
  add_args = new cljs.core.IndexedSeq(G__28991__a,0,null);
} 
return G__28989__delegate.call(this,add_fmt,add_args);};
G__28989.cljs$lang$maxFixedArity = 1;
G__28989.cljs$lang$applyTo = (function (arglist__28992){
var add_fmt = cljs.core.first(arglist__28992);
var add_args = cljs.core.rest(arglist__28992);
return G__28989__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq28899){
var G__28900 = cljs.core.first(seq28899);
var seq28899__$1 = cljs.core.next(seq28899);
var G__28901 = cljs.core.first(seq28899__$1);
var seq28899__$2 = cljs.core.next(seq28899__$1);
var G__28902 = cljs.core.first(seq28899__$2);
var seq28899__$3 = cljs.core.next(seq28899__$2);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28900,G__28901,G__28902,seq28899__$3);
}));
...
var seq__28921 = cljs.core.seq(features);
var chunk__28922 = null;
var count__28923 = (0);
var i__28924 = (0);
while(true){
if((i__28924 < count__28923)){
var feature = chunk__28922.cljs$core$IIndexed$_nth$arity$2(null,i__28924);
...
var G__28997 = seq__28921;
var G__28998 = chunk__28922;
var G__28999 = count__28923;
var G__29000 = (i__28924 + (1));
seq__28921 = G__28997;
chunk__28922 = G__28998;
count__28923 = G__28999;
i__28924 = G__29000;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__28921);
if(temp__5735__auto__){
var seq__28921__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__28921__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__28921__$1);
var G__29001 = cljs.core.chunk_rest(seq__28921__$1);
var G__29002 = c__4556__auto__;
var G__29003 = cljs.core.count(c__4556__auto__);
var G__29004 = (0);
seq__28921 = G__29001;
chunk__28922 = G__29002;
count__28923 = G__29003;
i__28924 = G__29004;
continue;
} else {
var feature = cljs.core.first(seq__28921__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__29009 = cljs.core.next(seq__28921__$1);
var G__29010 = null;
var G__29011 = (0);
var G__29012 = (0);
seq__28921 = G__29009;
chunk__28922 = G__29010;
count__28923 = G__29011;
i__28924 = G__29012;
continue;
}
} else {
...
var G__28929 = feature;
var G__28929__$1 = (((G__28929 instanceof cljs.core.Keyword))?G__28929.fqn:null);
switch (G__28929__$1) {
...
if(cljs.core.truth_(temp__5733__auto__)){
var o28932 = temp__5733__auto__;
return (o28932["version"]);
} else {
return null;
}
})() == null);
