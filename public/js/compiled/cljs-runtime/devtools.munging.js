...
var o26896 = temp__5733__auto__;
var temp__5733__auto____$1 = (o26896["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o26897 = temp__5733__auto____$1;
return (o26897["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26236__auto__ = f;
return (o__26236__auto__["toString"]).call(o__26236__auto__);
} else {
return "";
}
}catch (e26900){var _ = e26900;
return "";
}});
...
try{var o__26236__auto___27492 = t;
(o__26236__auto___27492["cljs$lang$ctorPrWriter"]).call(o__26236__auto___27492,t,writer);
}catch (e26910){var __27493 = e26910;
}
...
var char_code = (function (){var o__26236__auto__ = (new String(char$));
return (o__26236__auto__["charCodeAt"]).call(o__26236__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26236__auto__ = String;
return (o__26236__auto__["fromCharCode"]).call(o__26236__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__26951 = num_code;
switch (G__26951) {
case (1):
return (185);
...
var o__26236__auto__ = String;
return (o__26236__auto__["fromCharCode"]).call(o__26236__auto__,superscript_code);
});
/**
...
}catch (e26986){var _e__26249__auto__ = e26986;
return false;
}})())){
...
var vec__26997 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26997,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o27049 = temp__5733__auto__;
var temp__5733__auto____$1 = (o27049["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o27050 = temp__5733__auto____$1;
return (o27050["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27070){
var vec__27071 = p__27070;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27071,(0),null);
...
var G__27546 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__27547 = cljs.core.butlast(remaining_tokens);
name_tokens = G__27546;
remaining_tokens = G__27547;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27061){
...
var vec__27090 = cljs.core.split_with((function (p1__27084_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__27084_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27090,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27090,(1),null);
...
var vec__27113 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27113,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27113,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__27562 = cljs.core.rest(remaining_tokens);
var G__27563 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__27562;
name_tokens = G__27563;
continue;
} else {
...
var vec__27134 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27134,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27134,(1),null);
var vec__27137 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27137,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27137,(1),null);
var vec__27140 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27140,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27140,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27140,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27140,(3),null);
...
var vec__27169 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27169,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27169,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27169,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27169,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27169,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27169,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__27180 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27180,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27180,(1),null);
var vec__27185 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27185,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27185,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__27201 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__27201) : devtools.munging.parse_fn_info_deep.call(null,G__27201));
})()));
}
} else {
return fn_info;
...
var G__27592 = (arity + (1));
var G__27593 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27244){
var vec__27247 = p__27244;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27247,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27247,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27291_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__27291_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27292_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__27292_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___27621 = arguments.length;
var i__4737__auto___27625 = (0);
while(true){
if((i__4737__auto___27625 < len__4736__auto___27621)){
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27309){
var vec__27312 = p__27309;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27312,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27304){
var G__27305 = cljs.core.first(seq27304);
var seq27304__$1 = cljs.core.next(seq27304);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27305,seq27304__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27346__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27346__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27346__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27346__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27347 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27347,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27347,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27347,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27347,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27347,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27347,(5),null);
...
var o__26236__auto__ = f;
return (o__26236__auto__["getBasis"]).call(o__26236__auto__);
});
/**
...
}catch (e27362){var _e__26249__auto__ = e27362;
...
var G__27650 = (obj[cljs.core.first(path)]);
var G__27651 = cljs.core.rest(path);
obj = G__27650;
path = G__27651;
continue;
} else {
...
var _STAR_ = (function (accum,p__27399){
var vec__27401 = p__27399;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27401,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27401,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27413){
var vec__27415 = p__27413;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27415,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27415,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27415,(2),null);
...
var post_process = (function (p__27441){
var vec__27443 = p__27441;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27443,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27443,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27427_SHARP_){
return (obj[cljs.core.first(p1__27427_SHARP_)]);
}),sorted_matches);
