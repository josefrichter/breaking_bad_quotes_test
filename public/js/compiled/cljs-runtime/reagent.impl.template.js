...
var G__35637 = o;
(G__35637[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__35850__i < G__35850__a.length) {G__35850__a[G__35850__i] = arguments[G__35850__i + 0]; ++G__35850__i;}
  args = new cljs.core.IndexedSeq(G__35850__a,0,null);
} 
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__35651){
...
var props = map__35652__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35652__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__35661){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35662__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__35706){
...
var synthetic_on_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35707__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35707__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
...
var G__35719 = jsprops;
(G__35719["defaultValue"] = value);

(G__35719["onChange"] = (function (p1__35689_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change__$1,p1__35689_SHARP_);
}));
...
var vec__35741 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35741,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35741,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35741,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___35962 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___35962 == null)){
} else {
var key_35964 = temp__5739__auto___35962;
(jsprops["key"] = key_35964);
}
...
(reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__35762){
...
var synthetic_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35763__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__35766 = reagent.impl.template.__GT_NativeWrapper();
(G__35766["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__35767 = wrapped;
(G__35767["syntheticInput"] = true);

return G__35767;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__35768 = wrapped__$1;
(G__35768["syntheticOnChange"] = on_change);

return G__35768;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__35770 = wrapped__$2;
(G__35770["syntheticOnUpdate"] = on_update);
...
var G__36067 = (i__4737__auto___36061 + (1));
i__4737__auto___36061 = G__36067;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq35790){
var G__35791 = cljs.core.first(seq35790);
var seq35790__$1 = cljs.core.next(seq35790);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35791,seq35790__$1);
}));
...
break;
default:
var G__36088 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__36088;
continue;
...
var n__4613__auto___36108 = a.length;
var i_36110 = (0);
while(true){
if((i_36110 < n__4613__auto___36108)){
(a[i_36110] = reagent.impl.template.as_element((a[i_36110])));

var G__36112 = (i_36110 + (1));
i_36110 = G__36112;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4613__auto___36114 = a.length;
var i_36115 = (0);
while(true){
if((i_36115 < n__4613__auto___36114)){
var val_36117 = (a[i_36115]);
if(((cljs.core.vector_QMARK_(val_36117)) && ((reagent.impl.template.key_from_vec(val_36117) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_36115] = reagent.impl.template.as_element(val_36117));

var G__36120 = (i_36115 + (1));
i_36115 = G__36120;
continue;
} else {
}
...
var ctx = ({});
var vec__35825 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35825,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35825,(1),null);
...
var G__35830 = (cljs.core.count(argv) - first_child);
switch (G__35830) {
case (0):
